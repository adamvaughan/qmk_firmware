...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LALT, KC_LGUI, MO(_LOWER), KC_ENT, KC_SPC, MO(_RAISE), KC_RGUI, KC_RALT \
  ),
  ...
  */
  [_LOWER] = LAYOUT( \
    ...
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_RGHT, KC_UP, KC_DOWN, KC_NO, \
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC, KC_ENT, MO(_ADJUST), KC_RGUI, KC_RALT \
  ),
  ...
  * |      |      |  UP  |      |      |      |                    |      |      |      |      |      |      |
  * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
  * |      | LEFT | DOWN |RIGHT |      |      |-------.    ,-------|      | HOME | END  | PGUP |PGDWN |      |
  * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
  * | MUTE | VOL+ | VOL- |      | BR+  | BR-  |-------|    |-------|      |      |      |      |      |      |
  * `-----------------------------------------/       /     \      \-----------------------------------------'
  ...
  */
  [_RAISE] = LAYOUT( \
    ...
    KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_HOME, KC_END, KC_PGUP, KC_PGDN, KC_NO, \
  ...
  * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
  * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
  * |      |      |      |      |      |      |-------.    ,-------|RGB ON|MODE+ | HUE+ | SAT+ | BR+  | EFF+ |
  * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
  * |      |      |      |      |      |      |-------|    |-------|      |MODE- | HUE- | SAT- | BR-  | EFF- |
  * `-----------------------------------------/       /     \      \-----------------------------------------'
  *                   | LALT | LGUI |ADJUST| /       /       \      \  |ADJUST| RGUI | RALT |
  *                   |      |      |      |/       /         \      \ |      |      |      |
  *                   `----------------------------'           '------''--------------------'
  */
  [_ADJUST] = LAYOUT( \
    ...
    KC_LALT, KC_LGUI, MO(_ADJUST), KC_SPC, KC_ENT, MO(_ADJUST), KC_RGUI, KC_RALT \
  )
};
