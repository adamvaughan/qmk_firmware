...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [DEFAULT] = LAYOUT(
    ...
    KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN,                                      KC_4, KC_5, KC_6,
    KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT,                     KC_UP,               KC_1, KC_2, KC_3,
    MO(META), KC_LALT, KC_LGUI, KC_SPC, LT(META, KC_ENT), MO(SUPER), KC_LCTL,       KC_LEFT, KC_DOWN, KC_RGHT,         KC_0, KC_DOT),
  ...
  [META] = LAYOUT(
    ...
    KC_TRNS, KC_LALT, KC_LGUI, KC_SPC, KC_TRNS, KC_TRNS, KC_LCTL,                  KC_HOME, KC_PGDN, KC_END,            KC_0, KC_PDOT),
  ...
  [SUPER] = LAYOUT(
    ...
    KC_TRNS, KC_LALT, KC_LGUI, KC_SPC, KC_TRNS, KC_TRNS, KC_LCTL,                  KC_LEFT, KC_DOWN, KC_RGHT,              KC_NO,    KC_NO),
